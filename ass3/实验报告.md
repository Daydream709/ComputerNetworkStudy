...
本实验基于真实网络流量数据和BGP路由信息的分析，初步研究了网络使用模式与路由结构特征。通过实践，熟练掌握了Python在被动网络数据分析中的应用，理解了MapReduce编程模型在网络测量领域的实际运用，进一步加深了对网络协议及路由机制的理论认知与实践理解。